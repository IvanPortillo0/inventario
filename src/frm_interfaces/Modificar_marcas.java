 ...
 * @author ivanp
 */
public class Modificar_marcas extends javax.swing.JFrame {

    /**
     * Creates new form Modificar_marcas
     */
    public Modificar_marcas() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Modificar_marcas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Modificar_marcas().setVisible(true);
            }
        });
    }
