 ...
 * @author ivanp
 */
public class Registrar_categorias extends javax.swing.JFrame {

    /**
     * Creates new form Registrar_categorias
     */
    public Registrar_categorias() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registrar_categorias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registrar_categorias().setVisible(true);
            }
        });
    }
